 ...
 * @todo rename functions to be more meaningful
 */
...
function asn_enqueue_admin_scripts() {
	...
	wp_enqueue_script( 'admin-sticky-notes', ASN_URL . 'js/admin-sticky-notes.js', array(
		'jquery',
		'jquery-ui-draggable'
	), '1.0.0', false );
...
function asn_render_front_end_note_editor() {
	...
	<button id="toggle-editor">edit note</button>

	<div id="tj-admin-note-editor" class="hidden">
		<form action="" method="post" target="_self">
			<?php asn_metabox_fields(); ?>
